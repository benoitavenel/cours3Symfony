...
class RegistrationController extends AbstractController
{
    ...
    public function redirectUrl(): Response{
        if(str_contains('ROLE_ADMIN', $this->getUser()->getRoles()[0])){
            return $this->redirectToRoute('adminLanding');
        }else{
            return $this->redirectToRoute('userLanding');
        }
    }
